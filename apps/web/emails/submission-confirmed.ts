...
<html lang="en">
  <body style="margin:0;background-color:#f5f3ee;padding:32px 0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#1a1a1a;">
    <div style="max-width:520px;margin:0 auto;background-color:#ffffff;border-radius:12px;padding:32px;border:1px solid #e5e1d8;">
      ...
      <h1 style="font-size:22px;line-height:1.3;margin:0 0 16px;">Thanks — your interview experience is in.</h1>
      ...
      <a href="${esc(reportUrl)}" style="display:inline-block;background-color:#1a1a1a;color:#ffffff;text-decoration:none;padding:12px 20px;border-radius:8px;font-size:15px;font-weight:600;">View your experience</a>
